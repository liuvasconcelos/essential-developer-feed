//
//  EssentialDeveloperFeedAPIEndToEndTests.swift
//  EssentialDeveloperFeedAPIEndToEndTests
//
//  Created by Livia Vasconcelos on 04/04/21.
//

import XCTest
import EssentialDeveloperFeed

class EssentialDeveloperFeedAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
        let loader = LoadFeedImageDataFromRemoteUseCaseTests(client: ephemeralClient())
        trackForMemoryLeaks(loader, file: file, line: line)
