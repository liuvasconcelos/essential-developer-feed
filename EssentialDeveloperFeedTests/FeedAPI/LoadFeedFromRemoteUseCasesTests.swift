//
//  LoadFeedFromRemoteUseCasesTests.swift
//  LoadFeedFromRemoteUseCasesTests
//
...
class LoadFeedFromRemoteUseCasesTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut, toCompleteWith: failure(.connectivity)) {
            let clientError = NSError(domain: "Error test", code: 0)
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        let (sut, client) = makeSUT()
        let item1 = makeItem(imageURL: "http://a-url.com")
    ...
    private func makeItem(id: UUID = UUID(),
                          ...
                          location: String? = nil,
                          imageURL: String) -> (model: FeedImage, json: [String: Any]) {
