...
class CodableFeedStore {
    ...
    private struct CodableFeedImage: Codable {
        ...
        var local: LocalFeedImage {
            return LocalFeedImage(id: id, description: description,
        ...
        sut.insert(feed, timestamp: timestamp) { insertionError in
            ...
            sut.retrieve { firstResult in
                sut.retrieve { secondResult in
                    ...
                    default:
                        XCTFail("Expected retrievinf twice from non empty cache to deliver same found result with feed \(feed) and timestamp \(timestamp), got \(firstResult) and \(secondResult) instead")
                    }
