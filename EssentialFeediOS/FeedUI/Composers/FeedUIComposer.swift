...
public final class FeedUIComposer {
    ...
    public static func feedComposedWith(feedLoader: FeedLoader,
        ...
        presentationAdapter.presenter = FeedPresenter(feedView: FeedViewAdapter(controller: feedController, imageLoader: MainQueueDispatchDecorator(decoratee: imageLoader)),
